...
| --- | --- | --- | --- |
| Ten clean Web-Bench traces have aggregate unbounded / P=4 list ceilings of 4.2690x / 3.4058x; case median / maximum unbounded ceilings are 5.2293x / 6.4227x. | `results/historical_same_trace_replay/summary.csv` | `scripts/recompute_claims.py` recomputes aggregate work/span and finite-worker list ceilings from the sanitized per-case structural summary. | Zero-overhead same-trace structural replay; not realized end-to-end acceleration. |
