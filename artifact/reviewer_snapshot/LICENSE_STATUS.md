...
Runtime dependencies remain under their own licenses and are not vendored. See `THIRD_PARTY_NOTICES.md`. The package manifest and `SHA256SUMS` are regenerated after release-boundary changes.
